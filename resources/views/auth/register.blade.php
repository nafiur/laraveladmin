            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Register New Account</b></h4>
...
<form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
    ...
    <div class="form-group text-center row mt-3 pt-1">
        <div class="col-12">
            <button class="btn btn-success w-100 waves-effect waves-light" type="submit">Register</button>
        </div>
    </div>
