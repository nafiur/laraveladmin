...
@section('admin')
 ...
 @section('title'){{'Add New District'}} @endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Add District Page </h4><br><br>
                                <form method="post" action="{{ route('district.store') }}" id="myForm" >
                                        @csrf
                                    ...
                                    <!-- end row -->
                                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Add District">
                                </form>
                        </div>
                    </div>
                </div> <!-- end col -->
