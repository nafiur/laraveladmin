    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="px-4 py-3 rounded breadcrumb breadcrumb-alt bg-body-extra-light push fs-sm">
              ...
              <li class="breadcrumb-item active" aria-current="page">Edit Division Information</li>
            </ol>
          </nav>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Division Edit</h4><br><br>
                            <form method="post" action="{{ route('division.update') }}" id="myForm" >
                                @csrf
                                <input type="hidden" name="id" value="{{ $division->id }}">
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Division Name </label>
                                    <div class="form-group col-sm-10">
                                        <input name="name" class="form-control" value="{{ $division->name }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="name_bn" class="form-control" value="{{ $division->name_bn }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
