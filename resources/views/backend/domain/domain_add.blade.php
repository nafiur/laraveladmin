...
@section('admin')
 ...
 @section('title'){{'Add New Domain'}} @endsection
...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="px-4 py-3 rounded breadcrumb breadcrumb-alt bg-body-extra-light push fs-sm">
          ...
          <li class="breadcrumb-item active" aria-current="page">Add New Domain</li>
        </ol>
      </nav>
<div class="row">
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Add Domain Page </h4><br><br>
            
  

            <form method="post" action="{{ route('domain.store') }}" id="myForm" >
                @csrf
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="Add Domain">
            </form>
