    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="px-4 py-3 rounded breadcrumb breadcrumb-alt bg-body-extra-light push fs-sm">
              ...
              <li class="breadcrumb-item active" aria-current="page">Edit Educational Qualification Info</li>
            </ol>
          </nav>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('educationalqualification.update') }}" id="myForm" >
                                @csrf
                                <input type="hidden" name="id" value="{{ $educationalqualification->id }}">
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Educational Qualification Name </label>
                                    <div class="form-group col-sm-10">
                                        <input name="name" class="form-control" value="{{ $educationalqualification->name }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
