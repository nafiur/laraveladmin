...
--
-- Host: localhost:3306
-- Generation Time: Feb 17, 2023 at 01:57 PM
...
CREATE TABLE `downloads` (
  `id` bigint UNSIGNED NOT NULL,
  `form_name_english` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_name_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_category` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_type_doc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_type_pdf` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `form_type_xls` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
