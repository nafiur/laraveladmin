...
--
-- Host: localhost:3306
-- Generation Time: Feb 12, 2023 at 02:25 AM
...
CREATE TABLE `new_employees` (
  ...
  `marital_status_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `district_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_village` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_post` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_postal_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_division` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_district` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `present_upazilla` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permanent_village` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permanent_post` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permanent_postal_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `permanent_upazilla` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `smartcard` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bloodgroups_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobile` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `educational_qualification_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
